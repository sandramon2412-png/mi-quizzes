    ...
    },
    {
      ...
      questions: [
        { id: 'q1', text: 'Que sintoma se repite mas en ti ultimamente?', options: [
          ...
          { text: 'Ovarios / ciclo irregular', valor: 'ovarios', value: 'ovarios', profiles: ['ovarios'] },
          { text: 'Otro sintoma que se repite en mi cuerpo', valor: 'otro', value: 'otro', profiles: ['otro'] },
        ]},
        { id: 'q2', text: 'Desde cuando notas que tu cuerpo te habla con esta senal?', options: [
          { text: 'Desde hace pocas semanas, pero se esta haciendo evidente', profiles: ['ansiedad', 'vientre'] },
          { text: 'Desde hace meses y aparece por temporadas', profiles: ['cabeza', 'tiroides'] },
          { text: 'Desde hace anos, ya lo siento como parte de mi vida', profiles: ['lumbar', 'ovarios'] },
          { text: 'Desde una etapa antigua que todavia recuerdo con carga emocional', profiles: ['tiroides', 'otro'] },
        ]},
        { id: 'q3', text: 'Que suele pasar justo antes de que el sintoma aparezca o empeore?', options: [
          { text: 'Me guardo algo que queria decir para evitar problemas', profiles: ['tiroides'] },
          { text: 'Siento que todo depende de mi y no puedo parar', profiles: ['lumbar', 'ansiedad'] },
          { text: 'Me exijo resolverlo perfecto o controlar cada detalle', profiles: ['cabeza'] },
          { text: 'Me siento juzgada, expuesta o poco segura para mostrarme', profiles: ['vientre', 'ovarios'] },
          { text: 'No logro identificar un detonante claro', profiles: ['otro'] },
        ]},
        { id: 'q4', text: 'Que emocion se repite mas en tu dia a dia ahora mismo?', options: [
          { text: 'Culpa por descansar, pedir o elegirme primero', profiles: ['ansiedad'] },
          { text: 'Rabia contenida por callar lo que realmente siento', profiles: ['tiroides'] },
          { text: 'Miedo a avanzar sin apoyo o quedarme sola con todo', profiles: ['lumbar'] },
          { text: 'Tristeza silenciosa, vacio o ganas de esconderme', profiles: ['vientre', 'ovarios'] },
          { text: 'Agotamiento mental por pensar demasiado', profiles: ['cabeza'] },
        ]},
        { id: 'q5', text: 'Como reaccionas cuando tu cuerpo empieza a incomodarte?', options: [
          { text: 'Aprieto el pecho, respiro corto y sigo funcionando', profiles: ['ansiedad'] },
          { text: 'Me tenso en espalda, mandibula o cuello y sigo cargando', profiles: ['lumbar', 'tiroides'] },
          { text: 'Me voy a la mente: analizo, anticipo y no descanso', profiles: ['cabeza'] },
          { text: 'Me cierro, me hincho o siento que algo queda retenido', profiles: ['vientre'] },
          { text: 'Me desconecto de mi cuerpo femenino y de mi deseo', profiles: ['ovarios'] },
        ]},
        { id: 'q6', text: 'Que has intentado para sentir alivio?', options: [
          { text: 'Medicos o estudios, pero emocionalmente sigo igual', profiles: ['cabeza', 'lumbar'] },
          { text: 'Terapia, cursos o lectura personal, pero me falta guia diaria', profiles: ['tiroides', 'vientre'] },
          { text: 'Rutinas, respiracion o meditaciones sueltas sin constancia', profiles: ['ansiedad', 'otro'] },
          { text: 'Cambios hormonales, ciclos o autocuidado femenino, pero necesito ordenar el mensaje', profiles: ['ovarios'] },
        ]},
        { id: 'q7', text: 'Que frase describe mejor lo que necesitas desbloquear primero?', options: [
          { text: 'Necesito dejar de cargar con todo y permitirme apoyo', profiles: ['lumbar'] },
          { text: 'Necesito decir mi verdad sin sentir que hago dano', profiles: ['tiroides'] },
          { text: 'Necesito soltar el control y descansar mi mente', profiles: ['cabeza'] },
          { text: 'Necesito recuperar mi creatividad y sentirme segura expresandome', profiles: ['vientre'] },
          { text: 'Necesito volver a elegirme sin culpa', profiles: ['ansiedad'] },
          { text: 'Necesito honrar mi energia femenina y mi linaje', profiles: ['ovarios'] },
          { text: 'Necesito traducir mi sintoma especifico con claridad', profiles: ['otro'] },
        ]},
        { id: 'q8', text: 'Si tu resultado te diera una practica de 5 minutos, que preferirias recibir?', options: [
          { text: 'Una practica para liberar la voz y poner limites', profiles: ['tiroides'] },
          { text: 'Una respiracion para pecho, calma y autoeleccion', profiles: ['ansiedad'] },
          ...
          { text: 'Una pausa para soltar control y bajar la mente', profiles: ['cabeza'] },
          { text: 'Un ritual de vientre bajo, ciclo y energia femenina', profiles: ['ovarios'] },
