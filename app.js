    ...
    },
    {
      ...
      questions: [
        { id: 'q1', text: 'Que sintoma se repite mas en ti ultimamente?', options: [
          ...
          { text: 'Otro sintoma', valor: 'otro', value: 'otro', profiles: ['otro'] },
        ]},
        { id: 'q2', text: 'Desde cuando lo sientes?', options: [
          { text: 'Desde hace unos meses', profiles: ['vientre', 'ansiedad'] },
          { text: 'Desde hace anos', profiles: ['lumbar', 'cabeza', 'otro'] },
          { text: 'Desde que soy nina / adolescente', profiles: ['tiroides', 'ansiedad', 'ovarios'] },
        ]},
        { id: 'q3', text: 'Que emocion domina tu dia a dia ahora?', options: [
          ...
          { text: 'Tristeza / sensacion de vacio', profiles: ['vientre', 'cabeza', 'ovarios', 'otro'] },
        ]},
        { id: 'q4', text: 'Que has intentado para aliviarlo?', options: [
          { text: 'Medicos, estudios salen bien', profiles: ['cabeza', 'lumbar'] },
          { text: 'Terapia / cursos de desarrollo personal', profiles: ['tiroides', 'vientre', 'ovarios'] },
          { text: 'Nada me ha funcionado del todo', profiles: ['ansiedad', 'lumbar', 'otro'] },
        ]},
        { id: 'q5', text: 'Que necesitas desbloquear primero?', options: [
          { text: 'Entender el mensaje emocional de mi sintoma', profiles: ['vientre', 'cabeza', 'otro'] },
          { text: 'Saber que practica hacer para liberar la emocion', profiles: ['ansiedad', 'lumbar'] },
          { text: 'Ver mi mapa corporal completo paso a paso', profiles: ['tiroides', 'vientre', 'ovarios'] },
        ]},
      ],
      profiles: [
        {
