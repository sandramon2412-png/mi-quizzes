  ...
  return [
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'q2', text: 'Desde cuando lo notas?', options: [
          { text: 'Hace poco, pero ya me llamo la atencion', profiles: ['ansiedad', 'vientre'] },
          { text: 'Va y viene desde hace varios meses', profiles: ['cabeza', 'tiroides'] },
          { text: 'Llevo anos con esto o vuelve por temporadas', profiles: ['lumbar', 'ovarios'] },
          { text: 'Lo relaciono con una etapa dificil de mi vida', profiles: ['tiroides', 'otro'] },
        ]},
        { id: 'q3', text: 'Cuando suele sentirse mas fuerte?', options: [
          { text: 'Cuando tengo que hablar, poner limites o decir algo incomodo', profiles: ['tiroides'] },
          { text: 'Cuando siento demasiada responsabilidad encima', profiles: ['lumbar', 'ansiedad'] },
          { text: 'Cuando pienso demasiado o quiero controlar todo', profiles: ['cabeza'] },
          { text: 'Cuando me siento juzgada, expuesta o poco segura', profiles: ['vientre', 'ovarios'] },
          { text: 'No veo un patron claro todavia', profiles: ['otro'] },
        ]},
        { id: 'q4', text: 'Que emocion aparece mas seguido contigo?', options: [
          { text: 'Culpa por descansar o ponerme primero', profiles: ['ansiedad'] },
          { text: 'Rabia por callarme lo que pienso o siento', profiles: ['tiroides'] },
          { text: 'Miedo a avanzar sin apoyo suficiente', profiles: ['lumbar'] },
          { text: 'Tristeza, vacio o ganas de esconderme', profiles: ['vientre', 'ovarios'] },
          { text: 'Cansancio mental por pensar demasiado', profiles: ['cabeza'] },
        ]},
        { id: 'q5', text: 'Como responde tu cuerpo cuando estas bajo presion?', options: [
          { text: 'Se me aprieta el pecho o respiro mas corto', profiles: ['ansiedad'] },
          { text: 'Se me carga la espalda, cuello o mandibula', profiles: ['lumbar', 'tiroides'] },
          { text: 'Me duele la cabeza o no puedo apagar la mente', profiles: ['cabeza'] },
          { text: 'Siento hinchazon, retencion o nudo en el abdomen', profiles: ['vientre'] },
          { text: 'Siento desconexion con mi ciclo, deseo o energia femenina', profiles: ['ovarios'] },
        ]},
        { id: 'q6', text: 'Que has probado hasta ahora?', options: [
          { text: 'Chequeos, medicos o estudios, pero sigo buscando claridad emocional', profiles: ['cabeza', 'lumbar'] },
          { text: 'Terapia, cursos o lecturas, pero me falta una guia practica', profiles: ['tiroides', 'vientre'] },
          { text: 'Respiracion, meditacion o rutinas, pero no sostengo la constancia', profiles: ['ansiedad', 'otro'] },
          { text: 'Autocuidado femenino o revision de ciclo, pero quiero entender el mensaje', profiles: ['ovarios'] },
        ]},
        { id: 'q7', text: 'Que necesitas ahora mismo?', options: [
          { text: 'Sentirme apoyada y dejar de cargar sola', profiles: ['lumbar'] },
          { text: 'Poder decir mi verdad con mas calma', profiles: ['tiroides'] },
          { text: 'Descansar mi mente y soltar el control', profiles: ['cabeza'] },
          { text: 'Volver a crear, expresarme y confiar en mi', profiles: ['vientre'] },
          { text: 'Elegirme sin sentir tanta culpa', profiles: ['ansiedad'] },
          { text: 'Reconectar con mi energia femenina', profiles: ['ovarios'] },
          { text: 'Entender mi sintoma especifico paso a paso', profiles: ['otro'] },
        ]},
        { id: 'q8', text: 'Que tipo de ayuda te serviria mas para empezar?', options: [
          { text: 'Una practica corta para voz y limites', profiles: ['tiroides'] },
          { text: 'Una respiracion guiada para pecho y calma', profiles: ['ansiedad'] },
          { text: 'Un ejercicio corporal para sentir apoyo', profiles: ['lumbar'] },
          { text: 'Una guia para vientre, creatividad y expresion', profiles: ['vientre'] },
          { text: 'Una pausa para bajar la mente y descansar', profiles: ['cabeza'] },
          { text: 'Un ritual para ciclo, vientre bajo y feminidad', profiles: ['ovarios'] },
          { text: 'Un buscador donde escribir mi sintoma exacto', profiles: ['otro'] },
        ]},
      ],
      profiles: [
        {
