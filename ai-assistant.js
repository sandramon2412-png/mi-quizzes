...
TONO: cercano, directo, entusiasta pero sin exagerar. Respuestas cortas (2-4 oraciones). Cuando tenga sentido, invita al visitante a crear cuenta gratis o a ver los planes. No uses jerga técnica innecesaria. Responde siempre en español.`
  ...
  const PAGE_CONTEXTS = [
    ...
    {
      key: 'landing-builder',
      mode: MODES.find(m => m.id === 'landing'),
    ...
    },
    {
      ...
      mode: {
        ...
        label: 'Ebook Builder',
        icon: 'auto_stories',
        prompt: `Eres Lloyd dentro del Ebook Builder. Ayudas a estructurar ebooks, guias, checklists y lead magnets para infoproductos. Sugiere capitulos, mejora titulos, recomienda imagenes, portada, bonus y flujo de entrega. No prometas que puedes arreglar el PDF desde el chat; orienta sobre que revisar en el builder. Responde en espanol.`
      },
